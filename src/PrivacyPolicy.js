  ...
  return (
    <div className="PrivacyPolicyContainer">
      <div className="PrivacyPolicy Flex Column">
        ...
        <ul><li>any URL hyperlinks to external media present in the shared text</li><li>the time and date these were sent as messages</li><li>the name of the person who sent them as a message, as that name appears on the message in the shared text</li></ul>
