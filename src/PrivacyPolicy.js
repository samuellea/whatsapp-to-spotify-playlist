      ...
      <div className="PrivacyPolicy Flex Column">
        ...
        <p>By using the Google Drive functionality in this app, you agree to grant the app
          *read-only* access to your Google Drive and its files. This is necessary to allow the app to read the chat text file you have saved to Google Drive. <br /><br />The app cannot delete, create or edit files in your Google Drive, nor does it retain any of the personal data associated with your Google account, or share it with any third party.
          <br /><br />
          Signing out of the app clears and removes all credentials supplied by Google for accessing Google Drive files. You can also remove access by visting <a href="https://myaccount.google.com/permissions" style={{ color: 'white', fontWeight: 900 }} target="_blank">Account Settings</a> in your Google account (under 'Third-party apps with account access')
          <br /><br />
          Chatchoons' use and transfer of information received from Google APIs to any other app will adhere to <a href="https://developers.google.com/terms/api-services-user-data-policy" style={{ color: 'white', fontWeight: 900 }} target="_blank">Google API Services User Data Policy</a>, including the Limited Use requirements.
        </p>
