...
function Auth({ updateLoggedIn, loggedIn, showPrivacyPolicy }) {
  // this is our Login page if an existing user
  ...
  return (
    <div className="Auth Flex Column" style={{ opacity: fontsLoaded ? 1 : 0 }}>
      ...
      {!loginPending ? (
        ...
        >
          ...
          <div className="submitButtonContainer">
            <button className="authSubmitButton" onClick={handleClick}>
              Login
            </button>
          </div>
          <Link to="/signup" style={{ color: '#c98cff' }}>
            No account? Sign up
          </Link>
          <span className="ByProceedingNotice">
      ...
      <div className="LoginErrorContainer">
        {error ? (
          <span className="LoginErrorMsg Flex">
